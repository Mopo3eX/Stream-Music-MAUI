...
namespace Stream_Music_MAUI.Classes
{
    ...
    public class AutomaticCaptions
    {
        ...
        [JsonProperty("pt-PT")]
        public List<PtPT> ptPT { get; set; }
        public List<Pa> pa { get; set; }
        public List<Qu> qu { get; set; }
        public List<Ro> ro { get; set; }
        public List<Rn> rn { get; set; }

        [JsonProperty("ru-orig")]
        public List<RuOrig> ruorig { get; set; }
    ...
    public class Format
    {
        ...
        public object format_index { get; set; }
    ...
    public class RequestedDownload
    {
        ...
        public bool __write_download_archive { get; set; }
    }
    ...
    public class VideoInfo
    {
        ...
        public List<RequestedDownload> requested_downloads { get; set; }
        public string format_id { get; set; }
        public object format_index { get; set; }
        public string url { get; set; }
        public string manifest_url { get; set; }
